#include "plane_folder.h"


Plane_folder::Plane_folder(QWidget * parent)
{

}

Plane_folder::~Plane_folder()
{
...
void
Plane_folder::setStartCoefficient()
{
    _method_coefficients.name = "Plane";
    _method_coefficients.sphere_radius_multiplier = 1.5f;
    _method_coefficients.epsilon_cluster_branch = 0.05f;
    _method_coefficients.epsilon_cluster_stem = 0.025f;
    _method_coefficients.epsilon_sphere = 0.03f;
    _method_coefficients.minPts_ransac_stem = 123;
    _method_coefficients.minPts_ransac_branch = 500;
    ...
    _method_coefficients.min_radius_sphere_branch = 0.07f;

    _method_coefficients.a = 120.541;
    _method_coefficients.b = 3.215;
    _method_coefficients.fact = 2.5;
    _method_coefficients.minRad = 0.0025f;

    _method_coefficients.max_iterations = 2;
