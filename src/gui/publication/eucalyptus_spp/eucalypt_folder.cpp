#include "eucalypt_folder.h"

Eucalypt_folder::Eucalypt_folder(QWidget * parent)
{

}

Eucalypt_folder::~Eucalypt_folder()
{
...
void
Eucalypt_folder::setStartCoefficient()
{

    _method_coefficients.name = "Eucalyptus Spp.";
    _method_coefficients.sphere_radius_multiplier = 3.0f;
    _method_coefficients.epsilon_cluster_branch = 0.1f;
    _method_coefficients.epsilon_cluster_stem = 0.1f;
    _method_coefficients.epsilon_sphere = 0.045f;
    _method_coefficients.minPts_ransac_stem = 200;
    _method_coefficients.minPts_ransac_branch = 1200;
    _method_coefficients.minPts_cluster_stem = 3;
    _method_coefficients.minPts_cluster_branch = 3;
    _method_coefficients.min_radius_sphere_stem = 0.1f;
    _method_coefficients.min_radius_sphere_branch = 0.1f;

    _method_coefficients.a = 68.133;
    _method_coefficients.b = 2.328;
    _method_coefficients.fact = 3;
    _method_coefficients.minRad = 0.02;
