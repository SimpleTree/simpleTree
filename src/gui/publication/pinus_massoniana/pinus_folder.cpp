#include "pinus_folder.h"


Pinus_folder::Pinus_folder(QWidget * parent)
{

}

Pinus_folder::~Pinus_folder()
{
...
void
Pinus_folder::setStartCoefficient()
{

    _method_coefficients.name = "Pine";
    _method_coefficients.sphere_radius_multiplier = 1.5f;
    _method_coefficients.epsilon_cluster_branch = 0.025f;
    _method_coefficients.epsilon_cluster_stem = 0.035;
    _method_coefficients.epsilon_sphere = 0.02f;
    _method_coefficients.minPts_ransac_stem = 200;
    _method_coefficients.minPts_ransac_branch = 1111111;
    _method_coefficients.minPts_cluster_stem = 3;
    _method_coefficients.minPts_cluster_branch = 5;
    _method_coefficients.min_radius_sphere_stem = 0.07f;
    _method_coefficients.min_radius_sphere_branch = 0.05f;


    _method_coefficients.a = 137.498;
    _method_coefficients.b = 2.62;
