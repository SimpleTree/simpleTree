#ifndef QUERCUS_DENOISE_H
#define QUERCUS_DENOISE_H
...
class Quercus_denoise : public QDialog
{
        Q_OBJECT
...
public:
     ...
     * */
    Quercus_denoise(boost::shared_ptr<PCLViewer> viewer, QWidget * parent = 0);
