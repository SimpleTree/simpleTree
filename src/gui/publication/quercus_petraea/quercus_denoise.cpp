#include "quercus_denoise.h"

Quercus_denoise::Quercus_denoise(boost::shared_ptr<PCLViewer> viewer, QWidget * parent)
{
    this->viewer = viewer;
}

Quercus_denoise::~Quercus_denoise()
{
