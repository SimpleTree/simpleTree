#include "quercus_folder.h"

Quercus_folder::Quercus_folder(QWidget * parent)
{

}

Quercus_folder::~Quercus_folder()
{
...
void
Quercus_folder::setStartCoefficient()
{
    _method_coefficients.name = "Quercus";
    _method_coefficients.sphere_radius_multiplier = 1.8;
    _method_coefficients.epsilon_cluster_branch = 0.015f;
    _method_coefficients.epsilon_cluster_stem = 0.035f;
    _method_coefficients.epsilon_sphere = 0.025f;
    _method_coefficients.minPts_ransac_stem = 500;
    _method_coefficients.minPts_ransac_branch = 1111200;
    _method_coefficients.minPts_cluster_stem = 12;
    _method_coefficients.minPts_cluster_branch = 3;
    _method_coefficients.min_radius_sphere_stem = 0.07f;
    _method_coefficients.min_radius_sphere_branch = 0.03f;

    _method_coefficients.a = 240.559;
    _method_coefficients.b = 2.72;
    _method_coefficients.fact = 2.5;
    _method_coefficients.minRad = 0.0025;
    ...
    for ( int i = 0; i < files.size (); i++ )
    {
...

        {
            if (_cloud_Ptr != 0 ) {
                ...
                if ( tree != 0 ) {
                    //emit emitTreeID(files.at(i).append("_automatic_test"));
                    QString ID =files.at(i);
                    ID = ID.append("_automatic_test");
